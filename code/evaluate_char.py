...
from config import validate_data_path, validate_ensemble_fn, preprocess_data_path, preprocess_validate_data_fn, \
    column_list
...
if __name__ == "__main__":
    ...
    validation_pred = pd.read_csv(validate_data_path + validate_ensemble_fn)
    validation_real = pd.read_csv(preprocess_data_path + preprocess_validate_data_fn)
    f_scores = 0

    print(classification_report(validation_real["location_traffic_convenience"],
                                validation_pred["location_traffic_convenience"]))
    print(classification_report(validation_real["location_distance_from_business_district"],
                                validation_pred["location_distance_from_business_district"]))
    ...
    print(
        classification_report(validation_real["service_waiters_attitude"], validation_pred["service_waiters_attitude"]))
    print(classification_report(validation_real["service_parking_convenience"],
                                validation_pred["service_parking_convenience"]))
    ...
    print(classification_report(validation_real["others_overall_experience"],
                                validation_pred["others_overall_experience"]))
    print(classification_report(validation_real["others_willing_to_consume_again"],
                                validation_pred["others_willing_to_consume_again"]))

    # for index in range(1, 21):
    #     score = f1_score(validation_real[column_list[index]], validation_pred[column_list[index]], average='macro')
    #     print("[model%d's f1_score]:%d"%(index, score))
    #     f_scores += score
    # print("[average f1_score]:%d" %(f_scores / 20))


    f_scores += f1_score(validation_real["location_traffic_convenience"],
                         validation_pred["location_traffic_convenience"],
                         average="macro")
    ...
    f_scores += f1_score(validation_real["location_easy_to_find"], validation_pred["location_easy_to_find"],
                         average="macro")
    ...
    f_scores += f1_score(validation_real["service_waiters_attitude"], validation_pred["service_waiters_attitude"],
                         average="macro")
    ...
    f_scores += f1_score(validation_real["service_serving_speed"], validation_pred["service_serving_speed"],
                         average="macro")
    ...
    f_scores += f1_score(validation_real["price_cost_effective"], validation_pred["price_cost_effective"],
                         average="macro")
    ...
    f_scores += f1_score(validation_real["environment_decoration"], validation_pred["environment_decoration"],
                         average="macro")
    ...
    f_scores += f1_score(validation_real["environment_cleaness"], validation_pred["environment_cleaness"],
                         average="macro")
    ...
    f_scores += f1_score(validation_real["dish_recommendation"], validation_pred["dish_recommendation"],
                         average="macro")
    ...
    f_scores += f1_score(validation_real["others_willing_to_consume_again"],
                         validation_pred["others_willing_to_consume_again"],
                         average="macro")
    print(
        f1_score(validation_real["others_willing_to_consume_again"], validation_pred["others_willing_to_consume_again"],
                 average="macro"))

    print('average f_score:%f' % (f_scores / 20))
    # print(f_scores / 20)
